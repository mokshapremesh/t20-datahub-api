...
📖 **API Docs (Swagger UI):** https://t20-datahub-api.onrender.com/docs
📄 **API Documentation (PDF):** [T20-DataHub-API-Documentation.pdf](T20-DataHub-API-Documentation.pdf)
...
A full 15-page PDF reference covering all endpoints, request/response schemas, authentication flows, error codes, and worked examples is included in this repository:

📄 **[T20-DataHub-API-Documentation.pdf](T20-DataHub-API-Documentation.pdf)**

The interactive Swagger UI (auto-generated by FastAPI) is also available at:

- **Local:** http://localhost:8000/docs
- **Live:** https://t20-datahub-api.onrender.com/docs
...
University of Leeds — COMP 3011 Coursework
